...
struct __Object
{
    ...
    static Object __init(Object __this)
    {
        return __this;
    }
...
struct __String
{
    ...
    static String __init(String __this)
    {
        return __this;
    }

    // The init method for the constructor String(String)
    static String __init(String __this, std::string data)
    {
        __this->data = data;
        return __this;
    }
...
struct __Class
{
    ...
    static Class __init(Class __this)
    {
        return __this;
    }
