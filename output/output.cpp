...
__A_VT __A_VT__A::__vtable;
    void __A::setA(A A__this,String Stringx){
this->a=x;
    }
  
void __A::printOther(A A__this,A Aother){
...
__Test010_VT __Test010_VT__Test010::__vtable;
void __Test010::main(__rt::Array<String> Stringargs){
A Aa=new A();
;
({ auto temp1 = a;
